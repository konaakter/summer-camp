...
const img_token = import.meta.env.VITE_IMG;

const Addclass = () => {
    const { user } = useContext(AuthContext)
    const [axiosSecure] = useAxiosSecure();

    const img_host = `https://api.imgbb.com/1/upload?expiration=600&key=${img_token}`
    ...
    const onSubmit = data => {
        ...
        const addclass = {artCraftName: name, instructorEmail: instructorEmail, price,  instructorName: instructorname, totalSeats: parseInt(totalSeats), bookSeats : 0, status: 'panding' }
